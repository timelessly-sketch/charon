...
type Menu struct {
	Id            int         `json:"id"            orm:"id,omitempty"             description:"菜单ID"`  // 菜单ID
	...
	PinTab        bool        `json:"pinTab"        orm:"pin_tab"        description:"是否固定标签页"`         // 是否固定标签页
	...
	WithoutTab    bool        `json:"withoutTab"    orm:"without_tab"    description:"当前路由是否会被添加到Tab中"` // 当前路由是否会被添加到Tab中
